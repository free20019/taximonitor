...
public class yyshouyiDao {
	...
	public List<LOADONLINE>findyyshouyi(String time,int i){
		...
		String sql="select * from  hz_taxi.TB_TAXI_RUN_INFO_RECORD_test where" +
			...
			while (rs.next()) {
				...
				dbtime=rs.getString("db_time");
					if (dbtime.length()==10||dbtime.substring(11	, 16).equals("00:00")||dbtime.substring(11	, 16).equals("01:00")||dbtime.substring(11	, 16).equals("02:00")||dbtime.substring(11	, 16).equals("03:00")||dbtime.substring(11	, 16).equals("04:00")||dbtime.substring(11	, 16).equals("05:00")||dbtime.substring(11	, 16).equals("06:00")||dbtime.substring(11	, 16).equals("07:00")||dbtime.substring(11	, 16).equals("08:00")||dbtime.substring(11	, 16).equals("09:00")||dbtime.substring(11	, 16).equals("10:00")||dbtime.substring(11	, 16).equals("11:00")||dbtime.substring(11	, 16).equals("12:00")||dbtime.substring(11	, 16).equals("13:00")||dbtime.substring(11	, 16).equals("14:00")||dbtime.substring(11	, 16).equals("15:00")||dbtime.substring(11	, 16).equals("16:00")||dbtime.substring(11	, 16).equals("17:00")||dbtime.substring(11	, 16).equals("18:00")||dbtime.substring(11	, 16).equals("19:00")||dbtime.substring(11	, 16).equals("20:00")||dbtime.substring(11	, 16).equals("21:00")||dbtime.substring(11	, 16).equals("22:00")||dbtime.substring(11	, 16).equals("23:00")) {
						l.setRun_profit(rs.getString("run_profit"));
						list.add(l);
						}
			}
			rs.close();
	...
	public double findmeiyou(int i){
		...
		String sql="select sum(jine) jine from HZGPS_CITIZEN.TB_CITIZEN_"+time+"@TAXILINK45 t" +
		...
		try {
			...
			rs=ps.executeQuery();
			if (rs.next()) {
				BigDecimal  b4   =   new   BigDecimal(rs.getDouble("jine")/100/7000+"");  
	...
	public LOADONLINE zhuanhuan(List<LOADONLINE> list){
		...
		if (yingyun1.size()>0) {
			...
			}BigDecimal  b4   =   new   BigDecimal(b/yingyun1.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(0, f4+"");
		}else {
		...
		if (yingyun2.size()>0) {
			...
			for (int j = 0; j < yingyun2.size(); j++) {
				if(isInteger(yingyun2.get(j))){
					b+=Double.parseDouble(yingyun2.get(j));
				}
			}
			BigDecimal  b4   =   new   BigDecimal(b/yingyun2.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(1, f4+"");
		}else {
		...
		if (yingyun3.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun3.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(2, f4+"");
		}else {
		...
		if (yingyun4.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun4.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(3, f4+"");
		}else {
		...
		if (yingyun5.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun5.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(4, f4+"");
		}else {
		...
		if (yingyun6.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun6.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(5, f4+"");
		}else{
		...
		if (yingyun7.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun7.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(6, f4+"");
		}else {
		...
		if (yingyun8.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun8.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(7, f4+"");
		}else {
		...
		if (yingyun9.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun9.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(8, f4+"");
		}else {
		...
		if (yingyun10.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun10.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(9, f4+"");
		}else {
		...
		if (yingyun11.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun11.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(10, f4+"");
		}else {
		...
		if (yingyun12.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun12.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(11, f4+"");
		}else {
		...
		if (yingyun13.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun13.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(12, f4+"");
		...
		if (yingyun14.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun14.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(13, f4+"");
		}else {
		...
		if (yingyun15.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun15.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(14, f4+"");
		}else {
		...
		if (yingyun16.size()>0) {
			...
			BigDecimal  b4   =   new   BigDecimal(b/yingyun16.size()+"");  
			double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
			pingjunyingyun.add(15, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun17.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(16, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun18.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(17, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun19.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(18, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun20.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(19, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun21.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(20, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun22.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(21, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun23.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(22, f4+"");
		}else {
		...
		BigDecimal  b4   =   new   BigDecimal(b/yingyun24.size()+"");  
		double   f4   =   b4.setScale(2,   BigDecimal.ROUND_HALF_UP).doubleValue();  
		pingjunyingyun.add(23, f4+"");
	}else {
